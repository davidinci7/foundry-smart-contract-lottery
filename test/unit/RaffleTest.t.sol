...
contract RaffleTest is Test{
    ...
    function testCantEnterWhenRaffleIsCalculating() public{
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1); //Sets the test to an specific time
        vm.roll(block.number + 1); //Sets the test to an specific block
    ...
    // checkUpKeep          //
    //////////////////////////
    function testCheckUpKeppReturnsFalseIfItHasNoBalance() public{
